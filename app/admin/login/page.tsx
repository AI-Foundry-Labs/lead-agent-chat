...
const DEV_ACCOUNTS = [
  ...
  { label: 'Admin FR', email: 'admin_fr@gmail.com', password: 'admin123' },
  { label: 'Test 1', email: 'test1@test.com', password: 'test123' },
  { label: 'Demo', email: 'demo@agence-lumiere.fr', password: 'demo123' }
];
  ...
  return (
    <main className="flex min-h-[calc(100dvh-4rem)] items-center justify-center px-4 py-10">
      <div className="w-full max-w-md space-y-3">
        ...
        <Card className="border-border/80 p-8 shadow-[var(--shadow-elevated)]">
